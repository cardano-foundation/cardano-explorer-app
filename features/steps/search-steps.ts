...
Given(
  'there is {int} or less epochs in the blockchain',
  async (qty: number) => {
...
Given(
  'there is {int} or less blocks in the current epoch',
  async (qty: number) => {
    // Write code here that turns the phrase above into concrete actions
    return 'pending';
  }
...
Then('{string} button is disabled', async (label: string) => {
  // Write code here that turns the phrase above into concrete actions
  return 'pending';
});
...
Then('List of {int} latest blocks is shown', async (qty: number) => {
  // Write code here that turns the phrase above into concrete actions
  return 'pending';
});
...
Then('I can see transaction details:', async (dataTable: any) => {
  // Write code here that turns the phrase above into concrete actions
  return 'pending';
});

Then('I can see block details:', async (dataTable: any) => {
  // Write code here that turns the phrase above into concrete actions
  return 'pending';
});

Then('I can see block data:', async (dataTable: any) => {
  // Write code here that turns the phrase above into concrete actions
  return 'pending';
});

Then('I can see epoch details:', async (dataTable: any) => {
  // Write code here that turns the phrase above into concrete actions
  return 'pending';
});

Then('List of {int} latest epochs is shown', async (int: number) => {
  // Write code here that turns the phrase above into concrete actions
  return 'pending';
});

Then('I can see epoch data:', async (dataTable: any) => {
  // Write code here that turns the phrase above into concrete actions
  return 'pending';
});
...
Then('I can see {string} button', async (label: string) => {
  // Write code here that turns the phrase above into concrete actions
  return 'pending';
});
