...
Feature: Search
  ...
  Background: Given I am on the Cardano Explorer home page
    ...
    Scenario: Search for a transaction by transaction id and get transaction details
    ...
    Scenario: Search for block by block id and get block details
    ...
    Scenario: Search for address by address and get address details
    ...
    Scenario: Search for epoch by epoch number and get epoch details
    ...
    Scenario: Search for block by epoch and slot number and get block details
    ...
    Scenario: Search not matching anything supported
